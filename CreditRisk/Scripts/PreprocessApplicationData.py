...
class PreprocessApplicationData(object):
    ...
    def read_application_train_and_test_data(self):
        print(os.getcwd())
        application_train = pd.read_csv(os.path.join('credit-risk','Data','application_train.csv'))
        application_test = pd.read_csv(os.path.join('credit-risk','Data','application_test.csv'))
